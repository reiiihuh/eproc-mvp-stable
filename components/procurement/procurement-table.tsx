...
export function ProcurementTable({ records, showRequestId = true, extended = false, onEdit, onDelete, selected, setSelected }: { records: ProcurementRecord[]; showRequestId?: boolean; extended?: boolean; onEdit?: (record: ProcurementRecord) => void; onDelete?: (record: ProcurementRecord) => void; selected?: string[]; setSelected?: (ids: string[]) => void }) {
